...
typedef BOOL(^OCMockAuthenticationMethodOAuth2StartAuthenticationSessionForURLSchemeCompletionHandlerBlock)(__autoreleasing id *authenticationSession, NSURL *authorizationRequestURL, NSString *scheme, void(^completionHandler)(NSURL *_Nullable callbackURL, NSError *_Nullable error));
