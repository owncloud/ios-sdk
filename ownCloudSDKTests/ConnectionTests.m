...
- (void)testConnectAndGetThumbnails
{
	...
	[self _testConnectWithUserEnteredURLString:@"https://admin:admin@demo.owncloud.org" useAuthMethod:OCAuthenticationMethodBasicAuthIdentifier preConnectAction:nil connectAction:^(NSError *error, OCConnectionIssue *issue, OCConnection *connection) {
