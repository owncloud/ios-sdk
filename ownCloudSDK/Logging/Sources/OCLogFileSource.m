					...
					@autoreleasepool {
						...
						if ((availableData = [readingFileHandle availableData]) != nil)
						{
							...
							if ((logMessage = [[NSString alloc] initWithData:availableData encoding:NSUTF8StringEncoding]) != nil)
							{
								...
								[logger rawAppendLogLevel:OCLogLevelInfo functionName:nil file:sourceName line:0 tags:@[name] logMessage:logMessage threadID:threadID timestamp:timestamp forceSyncWrite:NO];
							}
						}
					}
				});
