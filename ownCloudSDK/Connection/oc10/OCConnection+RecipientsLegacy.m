	...
	progress = [self sendRequest:request ephermalCompletionHandler:^(OCHTTPRequest *request, OCHTTPResponse *response, NSError *error) {
		...
		if ((jsonDictionary = [response bodyConvertedDictionaryFromJSONWithError:&jsonError]) != nil)
		{
			...
			if ((ocsDictionary = jsonDictionary[@"ocs"]) != nil)
			{
				...
				{
					recipients = [self _recipientsFromJSONArray:dataDictionary[@"exact"][@"users"] matchType:OCIdentityMatchTypeExact addToArray:recipients];
					recipients = [self _recipientsFromJSONArray:dataDictionary[@"exact"][@"groups"] matchType:OCIdentityMatchTypeExact addToArray:recipients];
					recipients = [self _recipientsFromJSONArray:dataDictionary[@"exact"][@"remotes"] matchType:OCIdentityMatchTypeExact addToArray:recipients];

					recipients = [self _recipientsFromJSONArray:dataDictionary[@"users"] matchType:OCIdentityMatchTypeAdditional addToArray:recipients];
					recipients = [self _recipientsFromJSONArray:dataDictionary[@"groups"] matchType:OCIdentityMatchTypeAdditional addToArray:recipients];
					recipients = [self _recipientsFromJSONArray:dataDictionary[@"remotes"] matchType:OCIdentityMatchTypeAdditional addToArray:recipients];
				}
			}
		}
		else
