...
#pragma mark - Add/Remove sources
...
- (void)removeSources:(NSArray<OCDataSource *> *)source;
...
- (void)setInclude:(BOOL)include forSource:(OCDataSource *)source; //!< Include or exclude items from an individual source
