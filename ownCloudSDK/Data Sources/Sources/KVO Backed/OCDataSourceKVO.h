...
typedef NSArray<id<OCDataItem,OCDataItemVersioning>> * _Nullable (^OCDataSourceKVOVersionedItemUpdateHandler)(NSObject *object, NSString *keyPath, id _Nullable newValue);
