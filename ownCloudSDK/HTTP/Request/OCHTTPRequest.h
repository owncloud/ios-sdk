...
@interface OCHTTPRequest : NSObject <NSSecureCoding>
{
	...
	OCHTTPMethod _method;

	NSURL *_url;
	NSURL *_effectiveURL;
	OCHTTPRequestParameters _parameters;
	OCHTTPHeaderFields _headerFields;
	NSData *_bodyData;
	NSURL *_bodyURL;
	...
	OCHTTPRequestResultHandlerAction _resultHandlerAction;
	...
	NSDictionary *_userInfo;
 	...
 	OCHTTPRequestPriority _priority;
	OCHTTPRequestGroupID _groupID;
	BOOL _skipAuthorization;

	OCHTTPRequestObserver _requestObserver;
