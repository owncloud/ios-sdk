...
@interface GAUserUpdate : NSObject <GAGraphObject, NSSecureCoding>
...
@property(strong, nullable) NSString *onPremisesSamAccountName; //!< Contains the on-premises SAM account name synchronized from the on-premises directory.
