...
@class OCGDrive;
@class OCGPasswordProfile;

// occgen: type start
NS_ASSUME_NONNULL_BEGIN
@interface OCGUser : NSObject <OCGraphObject>
...
@property(strong, nullable) OCGPasswordProfile *passwordProfile;
...
@property(strong, nullable) NSArray<OCGDrive *> *drives; //!< A collection of drives available for this user. Read-only.
