...
// occgen: type start
@implementation OCGOpenGraphFile
...
{
	OCGOpenGraphFile *instance = [self new];

	OCG_SET(hashes, OCGHashes, Nil);
	OCG_SET(mimeType, NSString, Nil);
	OCG_SET(processingMetadata, NSNumber, Nil);
