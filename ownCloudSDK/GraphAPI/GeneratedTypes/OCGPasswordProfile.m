...
// occgen: type start
@implementation OCGPasswordProfile
...
{
	OCGPasswordProfile *instance = [self new];

	OCG_SET(forceChangePasswordNextSignIn, NSNumber, Nil);
	OCG_SET(password, NSString, Nil);
