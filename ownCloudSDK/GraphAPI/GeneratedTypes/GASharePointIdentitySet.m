...
// occgen: type start
@implementation GASharePointIdentitySet
...
{
	GASharePointIdentitySet *instance = [self new];
...
{
	return ([NSString stringWithFormat:@"<%@: %p%@%@>", NSStringFromClass(self.class), self, ((_user!=nil) ? [NSString stringWithFormat:@", user: %@", _user] : @""), ((_group!=nil) ? [NSString stringWithFormat:@", group: %@", _group] : @"")]);
}
