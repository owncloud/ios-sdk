...
extern OCAuthenticationMethodKey OCAuthenticationMethodWebFingerAccountLookupURLKey; //!< If a WebFinger lookup provided the base URL for auth detection, this contains the URL from which the lookup was derived.
